...
| :--- | :--- | :---: | :---: | :--- |
| **1. Emergency & SOS** | **One-Tap SOS Beacon:** พิกัด GPS (Lat/Lng), H3 Index, ระดับแบตเตอรี่, สถานะผู้เปราะบาง (เด็ก/คนแก่/ผู้ป่วย/ออกซิเจน) | $\le 28$ bytes (Single Packet) | **BLE Legacy/Extended Advertising** | ส่งได้ทันทีโดยไม่ต้องเชื่อมต่อ/จับคู่ รัศมี 30-100 ม. กินไฟต่ำสุด ปลอดภัยด้วย Ed25519 Signature |
| **2. Text & Chat** | **1-on-1 Private Messages (E2EE):** แชตส่วนบุคคลเข้ารหัส AES-256-GCM สองชั้น โหนดตัวกลางอ่านไม่ได้ (Security Overhead +28 bytes) | **แนะนำ 140–300 ตัวอักษร** (สูงสุดไม่เกิน 1,000 ตัวอักษร / < 1 KB) | **BLE GATT Mesh / Epidemic Gossip** | ส่งผ่าน Relay โหนด 3-15 ทอดตามความหนาแน่น ไร้เน็ต 100% |
| **3. Group Chat** | **กลุ่มผู้ประสบภัย / กลุ่มกู้ภัยเฉพาะจุด:** ถอดรหัสด้วย Group Secret Key (32B) + `TopicID` (4B) | **100–200 ตัวอักษร** (สูงสุดไม่เกิน 500 ตัวอักษร) | **BLE GATT Mesh (Targeted Flood)** | ครอบคลุมผู้ใช้ในพื้นที่เดียวกัน |
...
| **5. Voice Messages** | **คลิปเสียงสั้น (Push-to-Talk Voice Memo):** บันทึกเสียงแจ้งเหตุด้วย Opus Codec (Voice Mono 6–12 kbps) | **ความยาว 10–15 วินาที** (~15 KB – 30 KB) | **Wi-Fi Direct หรือ BLE Chunks** | ส่งผ่าน Wi-Fi หรือซอยส่งผ่าน BLE ได้ใน 10–30 วินาที |
| **6. Image Compression** | **ภาพถ่ายความเสียหาย (3-Tier Adaptive Image Engine):**<br>- 🔴 **Ultra-Low:** 320x240 WebP (5–15 KB)<br>- 🟡 **Standard:** 640x480 WebP (20–40 KB)<br>- 🟢 **High Detail:** 1280x720 WebP (100–200 KB) | <br>**5 KB – 15 KB**<br>**20 KB – 40 KB**<br>100 KB – 200 KB | <br>**BLE Mesh ส่งได้ทันทีใน 1-2s!**<br>**Wi-Fi Direct P2P (1s)**<br>Wi-Fi / Cloud Sync | บีบอัดในเครื่องลด 99% เห็นรอยแตก/สะพานขาดชัดเจน<br>*(🚫 วิดีโอปิดกั้นในโหมดออฟไลน์เพื่อรักษาแบตเตอรี่)* |
